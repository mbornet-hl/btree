 ...
 *
 *	@(#)	[MB] ci_epub.h	Version 1.8 du 19/11/29 - 
 */
...
int				 ci_traversal(ci_ref_root, void (*)(ci_ref_node, cc_uint16), cc_uint16);
int				 ci_cross(ci_ref_node, void (*)(ci_ref_node, cc_uint16), cc_uint16);
